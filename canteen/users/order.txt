...
$insert_orders = "INSERT INTO `user_orders` (user_id, amount_due, invoice_number, total_products, customization_description, order_date, order_status, quantity) 
                  VALUES ($user_id, $subtotal, $invoice_number, $count_products, '$customization_description', NOW(), '$status', $quantity)";
